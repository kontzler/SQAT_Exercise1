...
public class TestBowling {
	...
	@Test
	public void test_getfirstthrow_7() {
		Frame frame = new Frame(7,0);
		assertEquals("The first throw is not correctly displayed, 7 intended", 7, frame.getFirstThrow());
	}
	
	@Test
	public void test_getsecondthrow_4() {
		Frame frame = new Frame(5,4);
		assertEquals("this second throw is not correctly displayed, 4 intended",4, frame.getSecondThrow());
	}
